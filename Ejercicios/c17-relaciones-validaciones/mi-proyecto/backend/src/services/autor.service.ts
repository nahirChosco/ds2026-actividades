...
export async function create(datos: Prisma.AutorUncheckedCreateInput): Promise<Autor> {
  return prisma.autor.create({ data: datos }); 
}

export async function update(id: number, datos: Prisma.AutorUncheckedUpdateInput): Promise<Autor | null> {
